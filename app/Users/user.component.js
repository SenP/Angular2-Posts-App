System.register(['@angular/core', '@angular/router-deprecated', '@angular/common', '../common/users.service', '../common/userValidators', '../common/user'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, common_1, users_service_1, userValidators_1, user_1;
    var UserComponent;
    return {
        setters:[
            function (core_1_1) {
